 ...
 * 2017年6月13日
 */
public class TestQueryCardProductInfoSao extends TestImitatorBaseAction{
	...
	public void execute() throws UnsupportedEncodingException {
		...
		String cardProductId="productId_000001";
		this.setUri("/TSM/platform/cardproductsinfo/"+cardProductId);
	...
	public static void main(String[] args) {
		TestQueryCardProductInfoSao t=new TestQueryCardProductInfoSao();
		try {
			t.execute();
