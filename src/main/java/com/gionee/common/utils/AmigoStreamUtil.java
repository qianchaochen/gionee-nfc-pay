 ...
 * @since 2.0.0
 */
public class AmigoStreamUtil {
	private static final int DEFAULT_BUFFER_SIZE = 8192;

	public static InputStream string2Inputstream(String strxml) throws UnsupportedEncodingException {
		return new ByteArrayInputStream(strxml.getBytes(CharEncoding.UTF_8));
	}

	public static InputStream string2Inputstream(String strxml, String charset) throws UnsupportedEncodingException {
		return new ByteArrayInputStream(strxml.getBytes(charset));
	}
	...
	public static String readText(InputStream in) throws IOException {
		return readText(in, CharEncoding.UTF_8, -1);
	}
	...
	public static String readText(InputStream in, String encoding, int bufferSize) throws IOException {
		Reader reader = (encoding == null) ? new InputStreamReader(in, CharEncoding.UTF_8) : new InputStreamReader(in, encoding);
