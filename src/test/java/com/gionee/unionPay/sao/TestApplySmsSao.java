 ...
 * 2017年6月13日
 */
public class TestApplySmsSao extends TestImitatorBaseAction{
	...
	public void execute() throws UnsupportedEncodingException {
		...
		this.setUri("/TSM/platform/otpchallenge/"+virtualCardRefId);
	...
	public static void main(String[] args) {
		TestApplySmsSao t=new TestApplySmsSao();
		try {
			t.execute();
