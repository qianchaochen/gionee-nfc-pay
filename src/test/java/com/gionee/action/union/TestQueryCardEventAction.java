 ...
 * 2017年6月22日
 */
public class TestQueryCardEventAction extends TestBaseAction{
	public void excuete(){
		//指定执行环境
		...
		jsonBody.put("submitTime", "20170623141120");
	...
	public static void main(String[] args) {
		TestQueryCardEventAction t=new TestQueryCardEventAction();
		t.excuete();
	}
}
