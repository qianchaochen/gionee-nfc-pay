 ...
 * 2017年6月13日
 */
public class TestVerifySmsSao extends TestImitatorBaseAction{
	...
	public void execute() throws UnsupportedEncodingException {
		...
		this.setUri("/TSM/platform/otpverify/"+virtualCardRefId);
	...
	public static void main(String[] args) {
		TestVerifySmsSao t=new TestVerifySmsSao();
		try {
			t.execute();
